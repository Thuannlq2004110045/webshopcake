						...
						<form action="${pageContext.request.contextPath }/add-to-cart" method="post">
							<ul>
								<li>
									<div class="form-group quantity-box">
										...
										<input type="hidden" value=${cakeDetail.cakeId} name="cakeId">
										<input type="hidden" value="cakeDetail" name="now">
										<input class="form-control quantity-input" value="1" min="1" max="100" type="number" name="quantity">
									</div>
								</li>
							</ul>
							...
							<div class="price-box-bar">
								<div class="cart-and-bay-btn">
									<button type="submit" class="btn hvr-hover cart" data-fancybox-close="">Thêm vào giỏ </button>
								</div>
							</div>
						</form>
