        ...
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12">
              ...
              <h5>Bạn có thể thêm người dùng ở đây</h5>
            </div>
          </div>
          <!-- /. ROW  -->
          <hr />
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <form
                        role="form"
                        action="${pageContext.request.contextPath }/add-user"
                        method="post"
                      ...
                      >
                        <div class="form-group">
                          ...
                          <input
                            class="form-control"
                            placeholder="Hãy nhập vào tên tài khoản"
                            name="username"
                            type="text"
                          />
                        </div>
