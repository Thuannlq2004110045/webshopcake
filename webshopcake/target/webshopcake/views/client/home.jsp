...
<!-- Site Icons -->
<link href="<c:url value='/webapp/template/client/images/favicon.ico' />"
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">
								Chào mừng đến với cửa hàng bánh ngọt của chúng tôi! <br>
								Hãy thỏa sức lựa chọn với hàng trăm loại bánh ngon, tươi mới và đa dạng.
							</p>
							<p>
								<a class="btn hvr-hover" href="${pageContext.request.contextPath }">Shop Blog</a>
							</p>
						</div>
					</div>
				</div>
							...
							<div class="products-single fix">
								<div class="box-img-hover">
									...
									<div class="mask-icon">
										...
										<a class="cart"
											href="${pageContext.request.contextPath }/add-to-cart?cakeId=${cake.cakeId}&quantity=1">Thêm vào giỏ
										</a>
									</div>
								</div>
								<div class="why-text">
