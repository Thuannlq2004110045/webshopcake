      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <p>
              "Tại NamCakeShop, chúng tôi luôn hiểu rằng những chiếc bánh mới ra
              ...
              hàng chính là niềm vui của gia đình NamCakeShop"
            </p>
          </div>
        </div>
        <div class="row my-5">
        ...
        <div class="row my-4">
          <div class="col-12">
            <h2 class="noo-sh-title">About </h2>
          </div>
            ...
            <div class="hover-team">
              <div class="our-team">
                ...
                <div class="team-content">
                  <h3 class="title">Thuan Nguyen</h3>
              ...
              <div class="team-description">
                <p>
                  Hiểu biết: Jsp/Servlet, CSS, HTML, JS, SQL Server<br />
                  Công cụ: VS Code, GitHub<br />
                  Mục tiêu: Pro Web Developer
                </p>
              </div>
              <hr class="my-0" />
            </div>
