												...
												<div class="products-single fix">
													<div class="box-img-hover">
														...
														<div class="mask-icon">
															...
															<a class="cart" href="${pageContext.request.contextPath }/add-to-cart?cakeId=${cake.cakeId}&quantity=1&now=category&category=${cake.getCategory().getCategoryId()}">Thêm vào giỏ</a>
														</div>
													</div>
													<div class="why-text">
														<h4>${cake.cakeName }</h4>
											...
											<c:forEach var="cake" items="${cakeSearchByCategory}">
												...
												<div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
													<div class="why-text full-width">
														...
														<a class="btn hvr-hover cart" href="${pageContext.request.contextPath }/add-to-cart?cakeId=${cake.cakeId}&quantity=1&now=category&category=${cake.getCategory().getCategoryId()}">Thêm vào giỏ</a>
													</div>
												</div>
											</c:forEach>
										</div>
